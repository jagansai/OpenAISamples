...
public class AIConfig {
    ...
    VectorStore vectorStore(EmbeddingModel embeddingModel) {
        // Use SimpleVectorStore by default (matches 02-rag-loader). If a Redis-backed
        // VectorStore artifact is added later, this bean can be switched to that.
    ...
    // Note: for uploaded logs we will build a ByteArrayResource and use MarkdownDocumentReader
    // to produce Documents (avoids direct Document construction which may vary across versions).
}
